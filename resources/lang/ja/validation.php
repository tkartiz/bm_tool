...
return [
    ...
    'attributes'           => [
        ...
        'unit' => '単位',
        'comp1_name' => '１つ目の競合先名',
        'comp1_price_exc' => '１つ目の金額（税抜）',
        'comp1_price_incl' => '１つ目の金額（税込）',
        'comp2_name' => '2つ目の競合先名',
        'comp2_price_exc' => '2つ目の金額（税抜）',
        'comp2_price_incl' => '2つ目の金額（税込）',
        'comp3_name' => '3つ目の競合先名',
        'comp3_price_exc' => '3つ目の金額（税抜）',
        'comp3_price_incl' => '3つ目の金額（税込）',
    ],
];

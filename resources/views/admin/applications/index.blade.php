                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-2 py-3 bg-gray-100">
                                                @endif
                                                <form id="delete_{{ $application->id }}" method="post" action="{{ route('admin.applications.destroy', $application->id) }}">
                                                    @csrf
                                                    @method('delete')
                                            ...
                                            <td class="px-2 py-3 bg-gray-100">
                                                @endif
                                                <a href="{{ route('admin.applications.edit', $application->id) }}" class="w-full p-1 text-center">
                                            ...
                                            <td class="px-2 py-3">
                                                <a href="{{ route('admin.workspecs.index', ['application'=>$application->id]) }}" class="w-full p-1 text-center">

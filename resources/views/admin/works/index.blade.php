                                ...
                                <table class="table-auto w-full text-center whitespace-no-wrap">
                                    ...
                                    <tbody class="border">
                                        <tr>
                                            ...
                                            <td rowspan="2" class="p-2"><a href="{{ route('admin.works.show', $work->id) }}" class="text-blue-500 underline">{{ $work->id }}</a></td>
                                        ...
                                        <tr>
                                            <td class="w-10 pb-1">
                                                ...
                                                @elseif($os_appd->id === $work->os_appd_id && is_null($os_appd->requested_at))
                                            ...
                                            <td class="w-10 pb-1">
                                                ...
                                                @elseif($os_appd->id === $work->os_appd_id && is_null($os_appd->appd1_approval))
                                                <p class="mx-auto w-10 p-1 text-white text-sm bg-pink-200 rounded">未</p>
                                                @endif
                                                @endforeach
                                            </td>
                                            <td class="w-10 pb-1">
                                                ...
                                                @elseif($os_appd->id === $work->os_appd_id && is_null($os_appd->appd2_approval))
                                                <p class="mx-auto w-10 p-1 text-white text-sm bg-pink-200 rounded">未</p>
                                                @endif
                                                @endforeach
                                            </td>
